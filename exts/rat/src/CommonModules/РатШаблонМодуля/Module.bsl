...
Процедура ЗарегистрироватьОписание(СпецификацияСервиса) Экспорт
	...
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеПользователя, "Имя", "Имя пользователя", ТипСтрока, Истина);
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеПользователя, "НомерСеанса", "Номер сеанса", ТипЧисло, Истина);
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеПользователя, "ТипКлиента", "Клиент", ТипСтрока, Истина);
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеПользователя, "Начало", "Время подключения", ТипДата, Истина);
