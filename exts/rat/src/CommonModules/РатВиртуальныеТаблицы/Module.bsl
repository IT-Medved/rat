...
Функция СхемаИзмерения(Регистр, ДляОтвета)
	...
	Для Каждого Реквизит Из Регистр.Измерения Цикл
		...
		РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, Реквизит.Имя, Представление, Реквизит.Тип, Ложь, Ложь);
...
Функция СхемаТелаЗапросаОстатки(Регистр)
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "Период", ТипыДанных.Дата);
...
Функция СхемаТелаЗапросаОбороты(Регистр)
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "НачалоПериода", ТипыДанных.Дата);
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "КонецПериода", ТипыДанных.Дата);
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "Периодичность", РатOpenAPI.СсылкаНаСхему("periodicity"));
...
Функция СхемаТелаЗапросаОстаткиИОбороты(Регистр)
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "КонецПериода", ТипыДанных.Дата);
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "Периодичность", РатOpenAPI.СсылкаНаСхему("periodicity"));
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "МетодДополнения", РатOpenAPI.СсылкаНаСхему("completionMethod"));
...
Функция СхемаТелаОтветаОстатки(Регистр, ОписаниеКоллекции)
	...
	Для Каждого Реквизит Из Регистр.Ресурсы Цикл
		...
		Представление = Реквизит.Представление();
		РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, Реквизит.Имя + "Остаток", "Остаток " + Представление, Реквизит.Тип, Истина, Истина);
...
Функция СхемаТелаОтветаОбороты(Регистр, ОписаниеКоллекции)
	...
	Для Каждого Реквизит Из Регистр.Ресурсы Цикл
		...
		Представление = Реквизит.Представление();
		РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, Реквизит.Имя + "Оборот", "Оборот по " + Представление, Реквизит.Тип, Истина, Истина);
		РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, Реквизит.Имя + "Приход", "Приход по " + Представление, Реквизит.Тип, Истина, Истина);
		РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, Реквизит.Имя + "Расход", "Расход по " + Представление, Реквизит.Тип, Истина, Истина);
...
Функция БазоваяСхемаЗапроса(Регистр, Описание)
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "Условия", РатСпецификация.СсылкуНаСхему(Регистр, "Условия"));
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "Количество", ТипыДанных.ЦелоеЧисло, "Ограничение количества возвращаемых записей, если не указано - 10");
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "Поля", СхемаСписокПолей);
