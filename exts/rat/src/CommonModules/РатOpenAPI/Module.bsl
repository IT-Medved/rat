...
//   ДобавитьОписаниеРеквизита(Схема, "name", НоваяСхемаДанных("string"), "Имя пользователя");
//
Функция ДобавитьОписаниеРеквизита(СхемаОбъекта, ИмяСвойства, Знач СхемаСвойства, ОписаниеСвойства = Неопределено) Экспорт
...
// Пример:
//   Схема = НоваяСхемаОбъекта("Пользователь");
//   ДобавитьОписаниеРеквизита(Схема, "status", НоваяСхемаДанных("string"), "Статус пользователя");
