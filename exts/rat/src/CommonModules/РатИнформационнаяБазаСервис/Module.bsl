...
Процедура ЗарегистрироватьСхемыТабличныхЧастей(СпецификацияСервиса,
	...
	Для Каждого ТабличнаяЧасть Из Объект.ТабличныеЧасти Цикл
		...
		РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаВыходная, ТабличнаяЧасть.Имя, РатOpenAPI.СсылкаНаСхему(ИмяВыходнойСхемыТабличнойЧасти));
		...
		Если Описание.Редактирование Тогда
			...
			РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаВходная,
										ТабличнаяЧасть.Имя,
...
Функция ОписаниеСхемыРеквизитов(Описание, Реквизиты, РеквизитыТолькоДляЧтения, ЭтоВыходнаяСхема = Ложь)
	...
	Для Каждого Реквизит Из Реквизиты Цикл
		...
		РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, Реквизит.Имя, СхемаРеквизита);
...
Функция СхемаЗапросаИзмененияДанных(Знач Объект)
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "data", СхемаОписанияОбъекта);
...
Процедура БазоваяСхемаПараметровЗаписи(СпецификацияСервиса)
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "additionalProperties", СхемаДополнительныхСвойств);
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "additionalParameters", СхемаДополнительныхПараметров);
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, КлючПараметрыЗаписи, СхемаПараметровЗаписи);
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаПараметровЗаписи, "writeMode", РежимЗаписи);
	
	РежимПроведения = РатСпецификация.СхемаСистемногоПеречисления(РежимПроведенияДокумента, "Режим проведения документа");
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаПараметровЗаписи, "postingMode", РежимПроведения);
	
	СхемаЗаписиДокумента = РатКоллекции.СкопироватьСтруктуру(Схема);
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаЗаписиДокумента, КлючПараметрыЗаписи, СхемаПараметровЗаписи);
	...
	СхемаПараметровЗаписи = ПараметрыЗаписиОбъекта(ТипыДанных);
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаЗаписиРегистра, КлючПараметрыЗаписи, СхемаПараметровЗаписи);
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаПараметровЗаписи, "replace", ТипыДанных.Булево, "Замещать при записи, только для регистров");
...
Функция ПараметрыЗаписиОбъекта(ТипыДанных)
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаПараметровЗаписи,
...
Функция СхемаТелаПоиска(Объект)
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаТела, "filter", РатOpenAPI.НоваяСхемаСоставногоТипа(СхемыФильтра));
...
Процедура БазоваяСхемаРасширенногоПоиска(СпецификацияСервиса)
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "key", СхемаПоляКлюч);
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "value", СхемаЛюбойТип);
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "type", СхемаПоляТип);
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "condition", СхемаПоляУсловие);
...
Процедура БазоваяСхемаТелаПоиска(СпецификацияСервиса)
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "order", СхемаСортировка, "Сортировка");
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "fields", СхемаСписокПолей);
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "limit", ТипыДанных.ЦелоеЧисло,
