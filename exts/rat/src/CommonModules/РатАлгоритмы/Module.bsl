...
Функция ВычислитьВыражение(Выражение, Параметры = Неопределено) Экспорт
	...
	Возврат ВычислитьПроизвольноеВыражение(Выражение, Истина, Параметры);
...
Функция ВызватьФункцию(ИмяМетода, Параметры, БезопасныйРежим = Истина) Экспорт
	...
	Возврат ВычислитьПроизвольноеВыражение(Выражение, БезопасныйРежим, Параметры);
...
Процедура ВыполнитьАлгоритм(Выражение, Параметры = Неопределено) Экспорт
	...
	ВыполнитьПроизвольныйАлгоритм(Выражение, Истина, Параметры);
...
Функция ВычислитьПроизвольноеВыражение(Выражение, БезопасныйРежим, Параметры = Неопределено)
...
Процедура ВыполнитьПроизвольныйАлгоритм(Выражение, БезопасныйРежим, Параметры = Неопределено) Экспорт
