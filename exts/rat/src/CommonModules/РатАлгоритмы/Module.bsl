...
Функция ВычислитьВыражение(Выражение, Параметры = Неопределено) Экспорт
	...
	Возврат ВычислитьПроизвольноеВыражение(Выражение, Параметры, Истина);
...
//  БезопасныйРежим - Булево - Вызов метода в безопасном режиме
//
// Возвращаемое значение:
...
//   // Результат = 4
//
Функция ВызватьФункцию(ИмяМетода, Параметры, БезопасныйРежим = Истина) Экспорт
	
	Выражение = СигнатураМетода(ИмяМетода, Параметры);
	Возврат ВычислитьПроизвольноеВыражение(Выражение, Параметры, БезопасныйРежим);
...
Процедура ВыполнитьАлгоритм(Выражение, Параметры = Неопределено) Экспорт
	...
	ВыполнитьПроизвольныйАлгоритм(Выражение, Параметры, Истина);
...
Функция ВычислитьПроизвольноеВыражение(Выражение, Параметры = Неопределено, БезопасныйРежим = Истина)
...
Процедура ВыполнитьПроизвольныйАлгоритм(Выражение, Параметры = Неопределено, БезопасныйРежим = Истина) Экспорт
