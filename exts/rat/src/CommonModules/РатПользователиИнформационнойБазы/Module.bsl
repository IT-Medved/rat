...
Процедура ЗарегистрироватьОписаниеСхем(СпецификацияСервиса)
	...
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов,
											  ...
											  Истина);
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, "Имя", "Имя пользователя информационной базы", ТипСтрока, Ложь);
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, "ПолноеИмя", "Полное имя пользователя информационной базы", ТипСтрока, Ложь);
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов,
	...
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, "ЗащитаОтОпасныхДействий", "Защита от опасных действий", ТипБулево, Ложь);
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов,
	...
	Описание = РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, "РежимЗапуска", "Режим запуска клиентского приложения", ТипСтрока, Ложь);
	Описание.ВозможныеЗначения = РатПовтИсп.КлючиСистемногоПеречисления("РежимЗапускаКлиентскогоПриложения");
	
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, "ОсновнойИнтерфейс", "Основной интерфейс пользователя", ТипСтрока, Ложь);
	Описание.ВозможныеЗначения = ИменаКоллекцииМетаданных(Метаданные.Интерфейсы);
	
	Описание = РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, "Язык", "Язык пользователя информационной базы", ТипСтрока, Ложь);
