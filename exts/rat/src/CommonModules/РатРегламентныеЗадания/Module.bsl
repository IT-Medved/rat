...
Функция СтруктураОписанияРегламентногоЗадания()
	...
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов,
...
Процедура ЗарегистрироватьОписаниеОпераций(СпецификацияСервиса)
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаОтвета, "Остановлено", СхемаОстановленныхЗаданий);
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаОтвета, "Запущено", РатOpenAPI.СсылкаНаСхему("backgroundJob"), "Описание запущенного фонового задания");
...
Процедура ЗарегистрироватьОписаниеСхем(СпецификацияСервиса)
	...
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов,
									 ...
									 ТипУникальныйИдентификатор,
									 Истина);
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, "Наименование", "Описание задания", ТипСтрока);
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов,
									 "Ключ",
	...
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов,
									 ...
									 ,
									 Ложь);
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, "Начало", "Дата запуска задания.", ТипДата);
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, "Конец", "Дата завершения задания (только для завершенных заданий)", ТипДата);
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов,
									 "Расположение",
									 "URL сервера, на котором выполняется или выполнялось задание",
									 ТипСтрока,
									 Истина);
	ОписаниеРеквизита = РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, "Состояние", "Состояние задания", ТипСтрока);
	...
	// Описание расписания
	ОписаниеРеквизитов = РатСпецификация.ОписаниеРеквизитов();
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, "ДатаНачала", "Дата начала расписания", ТипДата);
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, "ВремяНачала", "Время начала расписания", ТипДата);
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, "ДатаКонца", "Дата конца расписания", ТипДата);
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, "ВремяКонца", "Время конца расписания", ТипДата);
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов,
									 "ВремяЗавершения",
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаДетальныеРасписанияДня, "ДетальныеРасписанияДня", СхемаКоллекцииРасписанийДня);
...
// Возвращает структуру полей расписания регламентного задания.
//
// Параметры:
//   Расписание - РасписаниеРегламентногоЗадания - расписание для описания
//
// Возвращаемое значение:
//   Структура, Неопределено - поля расписания со значениями исходного объекта
//
Функция ОписаниеРасписания(Расписание) Экспорт
