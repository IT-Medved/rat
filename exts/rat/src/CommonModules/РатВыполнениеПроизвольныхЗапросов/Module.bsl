...
Процедура ЗарегистрироватьОписание(СпецификацияСервиса) Экспорт
	...
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеТелаЗапроса, "Алгоритм", "Выполняемый алгоритм", Тип("Строка"), Истина);
	РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеТелаЗапроса,
									 "Параметры",
									 "Параметры алгоритма",
									 СхемаПараметров,
									 Истина,
