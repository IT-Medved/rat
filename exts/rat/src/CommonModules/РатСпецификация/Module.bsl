...
Функция ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, Имя, Представление, Тип, ТолькоЧтение = Ложь, Обязательный = Истина, ТолькоЗапись = Ложь) Экспорт
...
Функция СхемаПоОписаниюОбъекта(ОписаниеРеквизитов, Описание, ВыходнаяСхема = Ложь, СуществующиеСхемы = Неопределено) Экспорт
	...
	Для Каждого Реквизит Из ОписаниеРеквизитов Цикл
		...
		РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, Реквизит.Имя, ОписаниеПоля);
...
#Область Схемы
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаSuccess, "message", ТипыДанных.Строка, "Сообщение");
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаСтруктураСсылки,
								"type",
								ТипыДанных.Строка,
								"Имя типа, например CatalogRef.Пользователи, DocumentRef.ПКО");
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаСтруктураСсылки, "id", РатOpenAPI.СсылкаНаСхему(БазовыеСхемы.УникальныйИдентификатор));
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаСтруктураСсылки, "presentation", ТипыДанных.Строка, "Представление объекта");
...
Функция СхемаОшибки()
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаStackItem, "id", СхемаId);
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаStackItem, "description", ТипыДанных.Строка, "Расшифровка идентификатора");
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаStackItem, "message", ТипыДанных.Строка, "Сообщение об ошибке");
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаError, "id", СхемаId);
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаError, "description", ТипыДанных.Строка, "Расшифровка идентификатора");
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаError, "message", ТипыДанных.Строка, "Сообщение об ошибке");
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаError, "stack", СхемаРеквизитаStack);
