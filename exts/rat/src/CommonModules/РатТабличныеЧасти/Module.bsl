...
Процедура ЗарегистрироватьБазовыеСхемы(СпецификацияСервиса)
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаНастроек,
								"append",
								ТипыДанных.Булево,
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "filterBy", СхемаФильтрации);
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "settings", СхемаНастроек);
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "filter", СхемаФильтрации);
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "settings", СхемаНастроек);
...
Процедура ОперацияДобавлениеДанных(Методы, Ресурс, Группа, СхемаДанных)
	...
	Схема = РатOpenAPI.НоваяСхемаОбъекта();
	РатOpenAPI.ДобавитьОписаниеРеквизита(Схема, "data", СхемаДанных);
...
Функция СхемаТелаИзмененияСтроки(СхемаДанных)
	...
	РатOpenAPI.ДобавитьОписаниеРеквизита(СхемаИзменений, "data", СхемаДанных);
