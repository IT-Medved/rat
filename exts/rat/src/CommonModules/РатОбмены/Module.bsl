...
Процедура ЗарегистрироватьОписаниеСхем(СпецификацияСервиса)
	...
	ОписаниеРеквизитов = РатСпецификация.ОписаниеРеквизитов();
	ОписаниеРеквизита = РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов, "Статус", "Статус регистрации объекта", ТипСтрока, Истина);
	...
	ОписаниеРеквизита = РатСпецификация.ДобавитьОписаниеРеквизита(ОписаниеРеквизитов,
														 "НомерСообщения",
