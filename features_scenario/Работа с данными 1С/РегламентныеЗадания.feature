...
Сценарий: Ожидание регламентного задания
	...
	Дано Я устанавливаю максимальное время ожидания завершения регламентного задания "15"
	Когда Я запускаю регламентное задание "Пауза" внешней системы "RAT_REST" и ожидаю завершения
