...
//
Процедура ДобавитьОписаниеРеквизита(МассивРеквизитов, Реквизит, ЭтоСтандартныйРеквизит = Ложь)
...
Процедура ДобавитьРеквизитыТабличнойЧасти(МассивТабличныхЧастей, ТабличнаяЧасть)
	...
	Для Каждого РеквизитТЧ Из РеквизитыТЧ Цикл
		ДобавитьОписаниеРеквизита(НовТаблЧасть.Реквизиты, РеквизитТЧ);
	КонецЦикла;
...
Функция ДанныеПоОбъектуМетаданных(СсылкаНаОбъект)
	...
	Для Каждого Реквизит Из ОбъектМетаданных.СтандартныеРеквизиты Цикл
		...
		ДобавитьОписаниеРеквизита(ПараметрыОбъекта.Реквизиты, Реквизит, Истина);
	...
	Для Каждого Реквизит Из ОбъектМетаданных.Реквизиты Цикл
		...
		ДобавитьОписаниеРеквизита(ПараметрыОбъекта.Реквизиты, Реквизит);
...
//  ТекущийРеквизит					 - Структура - см. ДобавитьОписаниеРеквизита()
//									 - Неопределено
//  ПараметрыРеквизитаТабличнойЧасти - 	Структура:
//		* СтрокаТЧ - СтрокаТабличнойЧасти
//		* РеквизитТЧ - Структура - см. ДобавитьОписаниеРеквизита() 
//									 - Неопределено
// 
// Возвращаемое значение:
